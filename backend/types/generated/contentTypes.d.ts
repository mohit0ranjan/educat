...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    liveClasses: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiLectureLecture extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Lecture containing video URL and notes, linked directly to a subject/course';
    displayName: 'Lecture';
    pluralName: 'lectures';
  ...
  attributes: {
    ...
    notesUrl: Schema.Attribute.String;
...
export interface ApiLiveClassLiveClass extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    meetingLink: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiModuleModule extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A module inside a course';
    displayName: 'Module';
    pluralName: 'modules';
    singularName: 'module';
  };
...
export interface ApiWishlistWishlist extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'User wishlist of courses';
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    role: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    roletype: Schema.Attribute.Enumeration<['student', 'teacher']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    username: Schema.Attribute.String &
